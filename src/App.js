...
function TextExpander({collapsedNumWords = 10, expandButtonText = "Show more", collapseButtonText = "Show less", buttonColor = '#1f09cd', className, expanded = false, children}) {
